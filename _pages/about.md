...
1. Correlation function and descriptor based characterization of porous media.
...
1. Gradient based and non-gradient based topology optimization.
...
2. Similar framework for bulk ionic diffusion (with advection) for battery component optimization.
